...
<body>
    ...
    <div class="row">
        ...
        <div class="column middle">
                ...
                <div class="job-post">
                        <?php
                          $countSql = "SELECT * FROM job where job_name = 'Software Engineer' and job_id = (SELECT LAST_INSERT_ID());";
                          $countResult =  mysqli_query($conn, $countSql);
                          $count = mysqli_num_rows($countResult);
                          $firstRow = mysqli_fetch_assoc($countResult);
                        ...
                        <div class="job-post">
                          ...
                          <?php
                           $job_name = $secondRow['job_name'];
                           $company_name = $secondRow['company_name'];
                           $job_type = $secondRow['job_type'];
                           $location = $secondRow['location'];
                        ...
                        <?php
                          $job_name = $thirdRow['job_name'];
                          $company_name = $thirdRow['company_name'];
                          $job_type = $thirdRow['job_type'];
                          $location = $thirdRow['location'];
